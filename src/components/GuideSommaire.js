function Sommaire(){
    return(
        <section className="duration-500 ease-in-out ">
        <h2 className='pb-3 mb-4'><strong>Sommaire du Guide de Survie</strong></h2>
        ...
        <li className="flex items-center space-x-3 bg-gray-100 p-3 rounded-lg shadow-lg hover:scale-105 hover:bg-green-50 transition-all duration-300">
            <a href="#introduction" className="text-lg font-semibold text-gray-800 hover:text-green-600 hover:underline">Introduction</a>
        </li>
        <li className="flex items-center space-x-3 bg-gray-100 p-3 rounded-lg shadow-lg hover:scale-105 hover:bg-green-50 transition-all duration-300">
